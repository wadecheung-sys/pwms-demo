...
export const useAppStore = defineStore('app', {
  state: (): AppState => {
    return {
      ...
      dynamicRouter: false, // 使用静态业务路由
      serverDynamicRouter: false,
      fixedMenu: false, // 是否固定菜单

      layout: 'classic', // layout布局
      isDark: false, // 默认浅色主题（vue-element-plus-admin 默认）
  ...
  actions: {
    ...
    initTheme() {
      ...
      dark.value = false
      this.theme.topHeaderBgColor = '#fff'
      this.theme.topHeaderTextColor = 'inherit'
      this.theme.topHeaderHoverColor = '#f6f6f6'
      this.theme.topToolBorderColor = '#eee'
      this.theme.leftMenuBgColor = '#001529'
      this.setCssVarTheme()
      this.setMenuTheme(this.theme.leftMenuBgColor)
      this.setHeaderTheme(this.theme.topHeaderBgColor)
