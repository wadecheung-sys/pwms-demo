...
import { formatOrgOptionLabel, getOrgDescendantIds } from '@/utils/org'
  ...
  <div class="page-container">
    <div class="page-panel">
      <div class="panel-actions">
        <div class="panel-hint">录入生产仓<strong>地点</strong>（仓室主数据）：所属单位、资产性质、使用状态、面积、库管人员等，与仓内备品/仪器/工器具台账区分</div>
      ...
      <el-table :data="tableData" row-key="id" stripe border>
        ...
        <el-table-column label="操作" width="160" fixed="right">
          <template #default="{ row }">
            <template v-if="canEditWarehouse">
